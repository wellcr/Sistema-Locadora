	...
	<f:view>
		...
		<h:form styleClass="panel_cadastro">
			...
			<h:panelGrid columns="5">
				...
				<h:inputText value="#{vendedorBacking.nome}" maxlength="50" size="45" disabled="true"/>
				<div style="width: 1px"/>
				<h:outputText value=" Area de Venda: " />
				<h:inputText value="#{vendedorBacking.areaVenda}" maxlength="50" size="15" />
			</h:panelGrid>
			...
			<h:panelGrid columns="6">
				...
				<h:inputText value="#{vendedorBacking.estado}" maxlength="10" size="10"/>
			...
			<h:panelGrid columns="5">
				...
				<h:inputText value="#{vendedorBacking.idade}" maxlength="10" size="17" 
								onkeyup="masc_numero(this)"  disabled="true"/>
				...
				<h:panelGrid columns="2">
					<h:commandButton value="Salvar" action="#{vendedorBacking.alterar}"/>
